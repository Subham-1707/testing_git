     ...
     if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']== true)
      {
           ...
           echo '<div class="media my-1 mx-1">

                  <img src="media/profileMan.png" width="40px" class="mr-0" alt="...">
                  <p class="text-light my-1 mx-1">Welcome! '. ucfirst($_SESSION['username']).'</p>
                  
                </div>
                <a  href="partials/_logouthandler.php"  class="btn btn-outline-success my-2 my-sm-0"  style="height:35px; ">Logout</a>';
      }
      
      
else{
         echo ' <button class="btn btn-outline-success my-2 my-sm-0" data-toggle="modal" data-target="#loginModal" >Login</button>
